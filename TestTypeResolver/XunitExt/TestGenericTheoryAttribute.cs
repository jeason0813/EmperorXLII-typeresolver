...
namespace Xunit.Extensions {
    ...
    public class TestGenericTheoryAttribute {
        ...
        [Theory]
        [InlineData( "ConcreteMethod", typeof( GenericXunitTestCase ) )]
        [InlineData( "OneGenericArgument", typeof( GenericXunitTestCase ) )]
        [InlineData( "OneGenericParameter", typeof( GenericXunitTheoryTestCase ) )]
        [InlineData( "TwoGenericArguments", typeof( GenericXunitTestCase ) )]
        [InlineData( "TwoDifferentGenericArguments", typeof( GenericXunitTestCase ) )]
        [InlineData( "OneComplexGenericParameter", typeof( GenericXunitTheoryTestCase ) )]
        [InlineData( "TwoComplexGenericArguments", typeof( GenericXunitTestCase ) )]
        [InlineData( "TwoComplexGenericParameters", typeof( GenericXunitTheoryTestCase ) )]
        [InlineData( "PartiallySpecifiedGenericParameter", typeof( ExecutionErrorTestCase ) )]
        [InlineData( "MultipleUnconstrainedParameters", typeof( ExecutionErrorTestCase ) )]
        [InlineData( "UnimplementedParameter", typeof( ExecutionErrorTestCase ) )]
        public void GenericTheory_returns_expected_number_of_test_commands( string methodName, Type expectedTestCaseType ) {
            ...
            IXunitTestCase testCase = Assert.Single( testCommands );
            Assert.IsType( expectedTestCaseType, testCase );
        }
